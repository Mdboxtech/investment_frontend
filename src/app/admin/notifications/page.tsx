    ...
    <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <DialogDescription className="flex items-center gap-2 mt-1">
                  ...
                  <Badge variant="outline" className={selectedNotification ? priorityColors[selectedNotification.priority] : undefined}>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setShowDeleteDialog(false)} disabled={deletingAll}>
              Cancel
            </Button>
            <Button 
              variant="destructive" 
